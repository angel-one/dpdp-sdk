...
export function mapSpeechLanguage(language) {
    if (!language)
        return 'en-IN';
...
export function chunkSpeechText(text, maxLength = CHUNK_MAX_LENGTH) {
...
export function stopSpeech(onStateChange) {
...
export function speak(text, language, onStateChange) {
    const synthesis = getSpeechSynthesis();
