...
export declare function toggleChannel(state: BottomSheetState, purposeId: string, channelCode: string, purposes: IConsentPurpose[]): BottomSheetState;
...
export declare function reconcileStateAfterLanguageChange(state: BottomSheetState, purposes: IConsentPurpose[]): BottomSheetState;
...
export declare function buildSubmitPayload(data: IConsentUiResponse, action: ConsentButtonAction, state: BottomSheetState): IConsentSubmitPayload;
